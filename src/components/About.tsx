      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-6">
          <p className="text-xl md:text-2xl text-[#FDF5E6] font-medium leading-relaxed">
            I am a 24 years old Computer Science Engineering student currently pursuing my Master's at <span className="text-[#dc2626]">Politecnico di Milano</span>. My experience spans full-stack development, low-level programming, and hardware/software security.
          </p>
